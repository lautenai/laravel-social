...
{{Form::open(null, 'post', array('class' => 'form-stacked span16'))}}
	<fieldset>
		<div class="clearfix">
			...
			<div class="input">
				{{Form::text('follower_id', Input::old('follower_id', $relationships->follower_id), array('class' => 'span6'))}}
			</div>
		</div>
		<div class="clearfix">
			...
			<div class="input">
				{{Form::text('followed_id', Input::old('followed_id', $relationships->followed_id), array('class' => 'span6'))}}
			</div>
		</div>
